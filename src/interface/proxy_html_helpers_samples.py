...
u1 = 'https://www.programiz.com/c-programming/examples/factorial'
u2 = 'https://en.wikipedia.org/wiki/Worm'
u3 = 'https://stackoverflow.com/questions/48728707/reversing-till-underscore-is-found'
u4 = 'https://stackoverflow.com/questions/15955458/sort-an-array-in-a-c-function'
u5 = 'https://stackoverflow.com/questions/3893937/c-array-sorting-tips'
u6 = 'https://stackoverflow.com/questions/38624138/how-to-sort-an-array-by-passing-to-a-function-as-pointer-using-c'

text1 = '''
<!DOCTYPE html>


    <html itemscope itemtype="http://schema.org/QAPage" class="">

    <head>

        <title>c - Reversing till underscore is found - Stack Overflow</title>
        ...
        <meta property="og:url" content="https://stackoverflow.com/questions/48728707/reversing-till-underscore-is-found"/>
        <meta property="og:site_name" content="Stack Overflow" />
        <meta property="og:image" itemprop="image primaryImageOfPage" content="https://cdn.sstatic.net/Sites/stackoverflow/img/apple-touch-icon@2.png?v=73d79a89bded" />
        <meta name="twitter:card" content="summary"/>
        <meta name="twitter:domain" content="stackoverflow.com"/>
        <meta name="twitter:title" property="og:title" itemprop="title name" content="Reversing till underscore is found" />
        <meta name="twitter:description" property="og:description" itemprop="description" content="I was writing a C program to reverse the portion of a string before the first underscore character is found &#39;_&#39;
...
Another ..." />
        ...
        <script src="https://cdn.sstatic.net/Js/stub.en.js?v=c9e484ff97e0"></script>
    
    <link rel="stylesheet" type="text/css" href="https://cdn.sstatic.net/Shared/stacks.css?v=d1d3c28b4397">
        <link rel="stylesheet" type="text/css" href="https://cdn.sstatic.net/Sites/stackoverflow/primary.css?v=4cedc2cc6c01">
    
            <link rel="alternate" type="application/atom+xml" title="Feed for question &#39;Reversing till underscore is found&#39;" href="/feeds/question/48728707">
            <meta name="twitter:app:country" content="US" />
            <meta name="twitter:app:name:iphone" content="Stack Exchange iOS" />
            <meta name="twitter:app:id:iphone" content="871299723" />
            <meta name="twitter:app:url:iphone" content="se-zaphod://stackoverflow.com/questions/48728707/reversing-till-underscore-is-found" />
            <meta name="twitter:app:name:ipad" content="Stack Exchange iOS" />
            <meta name="twitter:app:id:ipad" content="871299723" />
            <meta name="twitter:app:url:ipad" content="se-zaphod://stackoverflow.com/questions/48728707/reversing-till-underscore-is-found" />
            <meta name="twitter:app:name:googleplay" content="Stack Exchange Android">
            <meta name="twitter:app:url:googleplay" content="http://stackoverflow.com/questions/48728707/reversing-till-underscore-is-found">
        ...
        <script>
            ...
            StackExchange.ready(function () {
                ...
                StackExchange.question.init({showAnswerHelp:true,totalCommentCount:2,shownCommentCount:2,highlightColor:'#F4A83D',backgroundColor:'#FFF',questionId:48728707});

                styleCode();

                    StackExchange.realtime.subscribeToQuestion('1', '48728707');
                // TODO: There's a CR for replacing this with inline info on the question for moderators
                // https://trello.com/c/ynDHhvrB/158-cr-move-the-mod-info-out-of-the-margin-and-into-the-post-estimate-needed
                // Before we roll out the sidebar everywhere (or at least shortly after that?), we should implement it.
                ...
                <script>
        StackExchange.init({"locale":"en","serverTime":1526212510,"routeName":"Questions/Show","stackAuthUrl":"https://stackauth.com","networkMetaHostname":"meta.stackexchange.com","site":{"name":"Stack Overflow","description":"Q&A for professional and enthusiast programmers","isNoticesTabEnabled":true,"enableNewTagCreationWarning":true,"insertSpaceAfterNameTabCompletion":false,"id":1,"childUrl":"https://meta.stackoverflow.com","enableSocialMediaInSharePopup":true,"protocol":"https"},"user":{"fkey":"d3bd8895f41aff6ca53c9af065ace4c2b98435957e68da56b4d24f22220d6be3","tid":"fc68c13c-4871-ff41-c7f3-efb46460232b","rep":0,"isAnonymous":true,"isAnonymousNetworkWide":true},"events":{"postType":{"question":1},"postEditionSection":{"title":1,"body":2,"tags":3}},"story":{"minCompleteBodyLength":75,"likedTagsMaxLength":300,"dislikedTagsMaxLength":300},"jobPreferences":{"maxNumDeveloperRoles":2,"maxNumIndustries":4}}, {"site":{"allowImageUploads":true,"commentHighlightingWithCSS":true,"enableUserHovercards":true,"styleCode":true,"enableImgurHttps":true,"forceHttpsImages":true},"userMessaging":{"showNewFeatureNotice":true},"comments":{},"userProfile":{"openGraphAPIKey":"58740831ad23540e00c58987"},"tags":{},"accounts":{"currentPasswordRequiredForChangingStackIdPassword":true},"flags":{"allowRetractingFlags":true},"snippets":{"snippetsEnabled":true,"renderDomain":"stacksnippets.net"},"paths":{},"markdown":{"asteriskIntraWordEmphasis":true},"monitoring":{"clientTimingsAbsoluteTimeout":30000,"clientTimingsDebounceTimeout":1000},"slack":{"sidebarAdDismissCookie":"slack-sidebar-ad"}});
        StackExchange.using.setCacheBreakers({"js/prettify-full.en.js":"ad7509b9b4d0","js/moderator.en.js":"55dcff1706fb","js/full-anon.en.js":"7ecff11f73d0","js/full.en.js":"d48f215e33be","js/wmd.en.js":"a0779cf01e50","js/third-party/jquery.autocomplete.min.js":"bdb258e949a8","js/third-party/jquery.autocomplete.min.en.js":"","js/mobile.en.js":"80539bd62657","js/help.en.js":"118cb359bcc6","js/tageditor.en.js":"435027aace35","js/tageditornew.en.js":"a3efd84478c4","js/inline-tag-editing.en.js":"e7aa31e8eba1","js/revisions.en.js":"be10a4167571","js/review.en.js":"a09fdd6087f3","js/tagsuggestions.en.js":"bb4721d888d2","js/post-validation.en.js":"6bfed356af5d","js/explore-qlist.en.js":"726bf7958c2a","js/events.en.js":"2933fe39d93b","js/keyboard-shortcuts.en.js":"f5c32ba00128","js/external-editor.en.js":"824b88c29bf5","js/adops.en.js":"22a9bd59b1e9","js/external-editor.en.js":"824b88c29bf5","js/snippet-javascript.en.js":"7d184f094cb6","js/snippet-javascript-codemirror.en.js":"d6b6b079f437"});
    ...
    <div class="-container">
        <div class="-main">
                    ...
                    <a class="-feature-notice
                       ...
                       " href="#"
                       data-unread-class="unread-feature-notice"
                       data-campaign="2018-05-03.teams landing" data-cookie="notice-sot" data-location="2" data-autopopup="false" data-expire-date="1529064000000">
                        <span>new</span>
                    </a>
                    <div class="topbar-dialog feature-notice-dialog js-feature-notice-dialog dno">
                        <div class="dialog-content">
                            <h4 class="bold">Stack Overflow for Teams</h4>
                            <p>A private, secure home for your team&#39;s questions and answers.</p>
                            <a class="btn-secondary js-cta-button js-gps-track" href="https://stackoverflow.com/teams" data-ga="[&quot;teams landing&quot;,&quot;New Feature Notification&quot;,&quot;https://stackoverflow.com/teams&quot;,null,{&quot;dimension4&quot;:&quot;teams landing&quot;}]"
                               data-gps-track="new_feature.click({campaign: '2018-05-03.teams landing', location: 2, action: 2})">Learn more</a>
                            <a class="icon-close js-close-button js-gps-track" title="Close and permanently remove this popup"
                               data-gps-track="new_feature.click({campaign: '2018-05-03.teams landing', location: 2, action: 1})"><svg aria-hidden="true" class="svg-icon iconClear" width="18" height="18" viewBox="0 0 18 18"><path d="M15 4.41L13.59 3 9 7.59 4.41 3 3 4.41 7.59 9 3 13.59 4.41 15 9 10.41 13.59 15 15 13.59 10.41 9z"/></svg></a>
                        </div>
                    </div>
...
<ol class="-secondary">
    ...
    <li class="-item">
        <a href="https://stackexchange.com" class="-link js-site-switcher-button js-gps-track" data-gps-track="site_switcher.show" title="A list of all 173 Stack Exchange sites">
            ...
            <li class="-ctas">
                        <a href="https://stackoverflow.com/users/login?ssrc=head&returnurl=https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found" class="login-link btn-clear" rel="nofollow">Log In</a>
...
>Sign up</a> or <a href="https://stackoverflow.com/users/login?ssrc=site_switcher&amp;returnurl=https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found" class="login-link js-gps-track"     data-gps-track="site_switcher.click({ item_type:11 })"
    ...
    <div class="-container g-row jc-sp-between ai-center">
        ...
        <div class="s-signup _hero g-col6">
            <div id="openid-buttons" class="-social">
                <a class="btn-outlined -white _medium _block" href="/users/signup?ssrc=hero&returnurl=https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found" rel="nofollow" data-ga="[&quot;sign up&quot;,&quot;Sign Up Navigation&quot;,&quot;Question Hero&quot;,null,null]">Email Sign Up</a>
                <span class="-or">or sign in with</span>
                    <div class="major-provider btn _block _medium _google" data-provider='google' data-oauthserver='https://accounts.google.com/o/oauth2/auth' data-oauthversion='2.0'
                         data-ga="[&quot;sign up&quot;,&quot;Sign Up Started - Google&quot;,&quot;Question Hero&quot;,null,null]">
<svg aria-hidden="true" class="svg-icon native iconGoogle" width="18" height="18" viewBox="0 0 18 18"><g><path d="M16.51 8H8.98v3h4.3c-.18 1-.74 1.48-1.6 2.04v2.01h2.6a7.8 7.8 0 0 0 2.38-5.88c0-.57-.05-.66-.15-1.18z" fill="#4285F4"/><path d="M8.98 17c2.16 0 3.97-.72 5.3-1.94l-2.6-2a4.8 4.8 0 0 1-7.18-2.54H1.83v2.07A8 8 0 0 0 8.98 17z" fill="#34A853"/><path d="M4.5 10.52a4.8 4.8 0 0 1 0-3.04V5.41H1.83a8 8 0 0 0 0 7.18l2.67-2.07z" fill="#FBBC05"/><path d="M8.98 4.18c1.17 0 2.23.4 3.06 1.2l2.3-2.3A8 8 0 0 0 1.83 5.4L4.5 7.49a4.77 4.77 0 0 1 4.48-3.3z" fill="#EA4335"/></g></svg>                                                Google
                    ...
                    <div class="major-provider btn _block _medium _facebook" data-provider='facebook' data-oauthserver='https://www.facebook.com/v2.0/dialog/oauth' data-oauthversion='2.0'
                         data-ga="[&quot;sign up&quot;,&quot;Sign Up Started - Facebook&quot;,&quot;Question Hero&quot;,null,null]">
            ...
            <form id="login-form" action="/users/signup?ssrc=hero&returnurl=https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found" method="POST">

                <input type="hidden" name="fkey" value="d3bd8895f41aff6ca53c9af065ace4c2b98435957e68da56b4d24f22220d6be3">
...
</script>    <div class="inner-content clearfix">
            <div id="question-header">
                    <h1 itemprop="name"><a href="/questions/48728707/reversing-till-underscore-is-found" class="question-hyperlink">Reversing till underscore is found</a></h1>

            
<div class="pl8 aside-cta" role="navigation" aria-label="ask new question">
        <a href="/questions/ask" class="ws-nowrap btn-outlined" >Ask Question</a>
</div>
...
<div class="question" data-questionid="48728707"  id="question">
...
<div class="vote">
        <input type="hidden" name="_id_" value="48728707">
...
<p>I was writing a C program to reverse the portion of a string before the first underscore character is found '_'</p>

<p><strong>For Example:</strong>
If the input is</p>

<pre><code>black_black
</code></pre>

<p>The output must be</p>

<pre><code>kcalb_black
</code></pre>

<p>Another input,</p>

<pre><code>nounderscore
</code></pre>

<p>Must reverse the whole string</p>

<pre><code>erocsrednuon
</code></pre>

<p>Another possibility of input,</p>
...
<p>Why doesn't my code work? It just returns garbage values.</p>
    </div>
...
<div class="post-menu"><a href="/q/48728707" title="short permalink to this question" class="short-link" id="link-post-48728707">share</a><span class="lsep">|</span><a href="/posts/48728707/edit" class="suggest-edit-post" title="">improve this question</a></div>        
    </div>

    <div class="post-signature grid--cell fl0">
<div class="user-info ">
    <div class="user-action-time">
        <a href="/posts/48728707/revisions" title="show all edits to this post">edited <span title="2018-02-11 05:51:55Z" class="relativetime">Feb 11 at 5:51</span></a>
    </div>
    <div class="user-gravatar32">
        <a href="/users/2988730/mad-physicist"><div class="gravatar-wrapper-32"><img src="https://i.stack.imgur.com/ZOX7t.jpg?s=32&amp;g=1" alt="" width="32" height="32"></div></a>
    </div>
    <div class="user-details">
        <a href="/users/2988730/mad-physicist">Mad Physicist</a>
        <div class="-flair">
            <span class="reputation-score" title="reputation score 24,218" dir="ltr">24.2k</span><span title="13 gold badges"><span class="badge1"></span><span class="badgecount">13</span></span><span title="52 silver badges"><span class="badge2"></span><span class="badgecount">52</span></span><span title="77 bronze badges"><span class="badge3"></span><span class="badgecount">77</span></span>
        </div>
    </div>
</div>    </div>
    <div class="post-signature owner grid--cell fl0">
        <div class="user-info ">
    <div class="user-action-time">
        asked <span title="2018-02-11 05:46:11Z" class="relativetime">Feb 11 at 5:46</span>
    </div>
    <div class="user-gravatar32">
        <a href="/users/9323603/blackdeath"><div class="gravatar-wrapper-32"><img src="https://www.gravatar.com/avatar/2fee4a1f0ad60f1ffca21dd3fceb1e87?s=32&amp;d=identicon&amp;r=PG&amp;f=1" alt="" width="32" height="32"></div></a>
    </div>
    <div class="user-details">
        <a href="/users/9323603/blackdeath">Blackdeath</a>
        <div class="-flair">
            <span class="reputation-score" title="reputation score " dir="ltr">55</span><span title="7 bronze badges"><span class="badge3"></span><span class="badgecount">7</span></span>
        </div>
    </div>
</div>
    </div>
    ...
    <div class="post-layout--right">
	    <div id="comments-48728707" class="comments js-comments-container ">
    ...
    <li id="comment-84456324" class="comment js-comment " data-comment-id="84456324">
        ...
        <div class="comment-text js-comment-text-and-form">
            <div style="display: block;" class="comment-body">
                <span class="comment-copy">You aren’t taking null terminators into account anywhere, <code>inputString[count] != &#39;_&#39;</code> doesn’t check for the end of the string, <code>stringTillUnderscore</code> isn’t null-terminated. You can do this in an easier way without copying, though, if you start with a function to reverse a string of a given length in place.</span>
                    &ndash;&nbsp;<a href="/users/707111/ry"
                       title="158,042 reputation"
                       class="comment-user">Ry-<span class="mod-flair" title="moderator">&#9830;</span></a>
                <span class="comment-date" dir="ltr"><span title="2018-02-11 05:50:01Z" class="relativetime-clean">Feb 11 at 5:50</span></span>
                        <span class="edited-yes" title="this comment was edited 2 times"></span>
                                                                            </div>
        </div>
    </li>
    <li id="comment-84456336" class="comment js-comment " data-comment-id="84456336">
        <div class="js-comment-actions comment-actions">
            <div class="comment-score">
            </div>
                    </div>
        <div class="comment-text js-comment-text-and-form">
            <div style="display: block;" class="comment-body">
                <span class="comment-copy">Show some sample outputs.</span>
                    &ndash;&nbsp;<a href="/users/2988730/mad-physicist"
                       title="24,218 reputation"
                       class="comment-user">Mad Physicist</a>
                <span class="comment-date" dir="ltr"><span title="2018-02-11 05:50:36Z" class="relativetime-clean">Feb 11 at 5:50</span></span>
                                                                            </div>
        </div>
    </li>
            </ul>
        ...
        <div id="comments-link-48728707" data-rep=50 data-anon=true>
...
<div id="tabs">
        <a href="/questions/48728707/reversing-till-underscore-is-found?answertab=active#tab-top" data-nav-xhref="" title="Answers with the latest activity first" data-value="active" data-shortcut="A">
            active</a>
        <a href="/questions/48728707/reversing-till-underscore-is-found?answertab=oldest#tab-top" data-nav-xhref="" title="Answers in the order they were provided" data-value="oldest" data-shortcut="O">
            oldest</a>
        <a class="youarehere " href="/questions/48728707/reversing-till-underscore-is-found?answertab=votes#tab-top" data-nav-xhref="" title="Answers with the highest score first" data-value="votes" data-shortcut="V">
            votes</a>
    </div>
                        </div>
                    </div>
...
<a name="48728726"></a>
<div id="answer-48728726" class="answer accepted-answer" data-answerid="48728726"  itemscope itemtype="http://schema.org/Answer" itemprop="acceptedAnswer">
    <div class="post-layout">
            <div class="votecell post-layout--left">
                

<div class="vote">
        <input type="hidden" name="_id_" value="48728726">
...
<div class="answercell post-layout--right">
    <div class="post-text" itemprop="text">
<p>You missing null terminating the string</p>
...
<pre><code>while(inputString[count] != '_') {
</code></pre>

<p>should be</p>

<pre><code>while (inputString[count] &amp;&amp; inputString[count] != '_') {
</code></pre>

<p>Just in case that the string does not have an underscore in it.</p>
    </div>
    <div class="grid mb0 fw-wrap ai-start jc-end gs8 gsy">
    <div class="grid--cell mr16" style="flex: 1 1 100px;">
<div class="post-menu"><a href="/a/48728726" title="short permalink to this answer" class="short-link" id="link-post-48728726">share</a><span class="lsep">|</span><a href="/posts/48728726/edit" class="suggest-edit-post" title="">improve this answer</a></div>                    </div>
    <div class="post-signature grid--cell fl0">
<div class="user-info user-hover">
    <div class="user-action-time">
        <a href="/posts/48728726/revisions" title="show all edits to this post">edited <span title="2018-02-11 07:32:50Z" class="relativetime">Feb 11 at 7:32</span></a>
    </div>
    <div class="user-gravatar32">
        <a href="/users/15168/jonathan-leffler"><div class="gravatar-wrapper-32"><img src="https://i.stack.imgur.com/WtEI9.png?s=32&amp;g=1" alt="" width="32" height="32"></div></a>
    </div>
    <div class="user-details">
        <a href="/users/15168/jonathan-leffler">Jonathan Leffler</a>
        <div class="-flair">
            <span class="reputation-score" title="reputation score 527,848" dir="ltr">528k</span><span title="82 gold badges"><span class="badge1"></span><span class="badgecount">82</span></span><span title="622 silver badges"><span class="badge2"></span><span class="badgecount">622</span></span><span title="968 bronze badges"><span class="badge3"></span><span class="badgecount">968</span></span>
        </div>
    </div>
</div>    </div>
    ...
    <div class="user-info user-hover">
    <div class="user-action-time">
        answered <span title="2018-02-11 05:49:59Z" class="relativetime">Feb 11 at 5:49</span>
    </div>
    <div class="user-gravatar32">
        <a href="/users/892256/ed-heal"><div class="gravatar-wrapper-32"><img src="https://i.stack.imgur.com/15FJW.png?s=32&amp;g=1" alt="" width="32" height="32"></div></a>
    </div>
    <div class="user-details">
        <a href="/users/892256/ed-heal">Ed Heal</a>
        <div class="-flair">
            <span class="reputation-score" title="reputation score 45,453" dir="ltr">45.5k</span><span title="12 gold badges"><span class="badge1"></span><span class="badgecount">12</span></span><span title="61 silver badges"><span class="badge2"></span><span class="badgecount">61</span></span><span title="101 bronze badges"><span class="badge3"></span><span class="badgecount">101</span></span>
        </div>
    </div>
</div>
    </div>
    ...
    <div class="post-layout--right">
	    <div id="comments-48728726" class="comments js-comments-container ">
            <ul class="comments-list js-comments-list"
                    data-remaining-comments-count="0"
                    data-canpost="false"
                    data-cansee="true"
    ...
    <li id="comment-84457620" class="comment js-comment " data-comment-id="84457620">
        <div class="js-comment-actions comment-actions">
            <div class="comment-score">
            </div>
                    </div>
        <div class="comment-text js-comment-text-and-form">
            <div style="display: block;" class="comment-body">
                <span class="comment-copy">@jonathanLeffer - thanks for the edit. I was being lazy and if at work I would put in the comparison with <code>0</code></span>
                    &ndash;&nbsp;<a href="/users/892256/ed-heal"
                       title="45,453 reputation"
                       class="comment-user">Ed Heal</a>
                <span class="comment-date" dir="ltr"><span title="2018-02-11 07:38:17Z" class="relativetime-clean">Feb 11 at 7:38</span></span>
                                                                            </div>
        </div>
    </li>
            </ul>
        ...
        <div id="comments-link-48728726" data-rep=50 data-anon=true>
...
<a name="48730560"></a>
<div id="answer-48730560" class="answer" data-answerid="48730560"  itemscope itemtype="http://schema.org/Answer">
    <div class="post-layout">
            <div class="votecell post-layout--left">
                

<div class="vote">
        <input type="hidden" name="_id_" value="48730560">
        <a class="vote-up-off" title="This answer is useful">up vote</a>
...
<div class="answercell post-layout--right">
    <div class="post-text" itemprop="text">
<p>you just forgot to include the 
    <strong>string.h</strong></p>

<p>there is no need to include 
    <strong>stdlib.h</strong></p>

<p>also there is no need to declare the character array
    <em>stringAfterUnderscore[100]</em></p>
...
int main()
{
  ...
  return 0;
    ...
    <div class="grid mb0 fw-wrap ai-start jc-end gs8 gsy">
    <div class="grid--cell mr16" style="flex: 1 1 100px;">
<div class="post-menu"><a href="/a/48730560" title="short permalink to this answer" class="short-link" id="link-post-48730560">share</a><span class="lsep">|</span><a href="/posts/48730560/edit" class="suggest-edit-post" title="">improve this answer</a></div>                    </div>
    ...
    <div class="user-info ">
    <div class="user-action-time">
        answered <span title="2018-02-11 10:33:23Z" class="relativetime">Feb 11 at 10:33</span>
    </div>
    <div class="user-gravatar32">
        <a href="/users/8350819/chetan-neve"><div class="gravatar-wrapper-32"><img src="https://i.stack.imgur.com/ogUxf.jpg?s=32&amp;g=1" alt="" width="32" height="32"></div></a>
    </div>
    <div class="user-details">
        <a href="/users/8350819/chetan-neve">CheTan Neve</a>
        <div class="-flair">
    ...
    <div class="post-layout--right">
	    <div id="comments-48730560" class="comments js-comments-container  dno">
            <ul class="comments-list js-comments-list"
                    data-remaining-comments-count="0"
                    data-canpost="false"
                    data-cansee="true"
        ...
        <div id="comments-link-48730560" data-rep=50 data-anon=true>
            ...
            <a class="js-show-link comments-link dno" title="expand to show all comments on this post" href=# onclick=""></a>
                                    ...
                                    <a name='new-answer'></a>
                        <form id="post-form" action="/questions/48728707/answer/submit" method="post"  class="post-form">
                            <input type="hidden" id="post-id" value="48728707" />
...
<div id="post-editor" class="post-editor js-post-editor">
    ...
    <div class="edit-block">
        <input id="fkey" name="fkey" type="hidden" value="d3bd8895f41aff6ca53c9af065ace4c2b98435957e68da56b4d24f22220d6be3">
        <input id="author" name="author" type="text">
                ...
                <div class="new-login-form">
                    <div class="new-login-left">
                        <h3>Sign up or <a id="login-link" href="/users/login?ssrc=question_page&returnurl=https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found%23new-answer">log in</a></h3>
                        <script>
                            StackExchange.ready(function () {
    ...
    <div class="form-item">
        ...
        <tr>
            ...
            <script>
                StackExchange.ready(
                    function () {
                        StackExchange.openid.initPostLogin('.new-post-login', 'https%3a%2f%2fstackoverflow.com%2fquestions%2f48728707%2freversing-till-underscore-is-found%23new-answer', 'question_page');
                    }
                );
            </script>
            <noscript>
...
By posting your answer, you agree to the <a href='https://stackexchange.com/legal/privacy-policy' name='privacy' target='_blank'>privacy policy</a> and <a href='https://stackexchange.com/legal/terms-of-service/public' name='tos' target='_blank'>terms of service</a>.</p>
...
Not the answer you&#39;re looking for?                            Browse other questions tagged <a href="/questions/tagged/c" class="post-tag" title="show questions tagged &#39;c&#39;" rel="tag">c</a> <a href="/questions/tagged/string" class="post-tag" title="show questions tagged &#39;string&#39;" rel="tag">string</a>  or <a href="/questions/ask">ask your own question</a>.                        </h2>
            </div>
        </div>
                    ...
                    <table id="qinfo">
                        <tr>
                            ...
                            <td style="padding-left: 10px">
                                <p class="label-key" title="2018-02-11 05:46:11Z"><b>3 months ago</b></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <tr>
                                ...
                                <td style="padding-left: 10px">
                                    <p class="label-key"><b><a href="?lastactivity" class="lastactivity-link" title="2018-02-11 10:33:23Z">3 months ago</a></b></p>
                                </td>
                            </tr>
                    </table>
                </div>
...
<div id="clc-tsb" class="everyonelovesstackoverflow everyoneloves__top-sidebar"></div>
            <div id="hireme"></div>
<script>;try{(function(a){function b(a){return document.getElementById(a)}function c(a){return a='string'==typeof a?b(a):a,!!a&&'none'===getComputedStyle(a).display}function d(a){return!c(a)}function e(a){return!!a}function f(a){var b=a.style;b.height=b.maxHeight=b.minHeight='auto',b.display='none',[].forEach.call(a.children,f)}function g(){try{return!new Function('return async()=>{};')}catch(a){return!0}}function h(){'function'==typeof clc.load?clc.load():q.push(function(a){return a.load()})}function i(){if(r.allowed&&new RegExp(r.allowed).test(location.hostname)&&!c('hireme')){var a=r.wv;if(document.hidden&&a){var b=function(){document.hidden||(i(),document.removeEventListener('visibilitychange',b))};return void document.addEventListener('visibilitychange',b)}if(r.al&&h(),'function'!=typeof clc.load){var d=g()?r.lib.replace(/(\.min)?\.js(\?v=[0-9a-fA-F]+)?$/,'.ie$1.js$2'):r.lib,e=document.createElement('script');e.src=d,document.body.appendChild(e)}}}function j(){return Object.keys(v.ids)}function k(a){var b=v.ids[a],c=v.slots[b];'function'==typeof c&&(c=c(a));return{path:'/'+s+'/'+u+'/'+b+'/'+t,sizes:c,zone:b}}function l(){var a=document.createElement('div');a.className='adsbox',a.id='clc-abd',a.style.position='absolute',a.style.pointerEvents='none',a.innerHTML='&nbsp;',document.body.appendChild(a)}function m(a){var b=a.serviceName,c=a.slot,d=a.lineItemId;try{var e=c.getSlotElementId(),g=[];e||g.push('id=0');var h=document.getElementById(e);if(!e||h?h.hasAttribute('data-clc-stalled')&&g.push('st=1'):g.push('el=0'),0!==g.length)return void w(g.join('&'));-1===r.dh.indexOf(d)?h.setAttribute('data-clc-prefilled','true'):f(h),h.setAttribute('data-clc-ready','true')}catch(a){var i=document.querySelector('#dfp-tsb, #dfp-isb, #clc-tsb');i&&i.setAttribute('data-clc-ready','true'),w('e=1')}}function n(a){if(!!clc.collapse)return clc.collapse[a];return'lb'!==a&&'mlb'!==a||!!clc.collapse_leaderboards}function o(a,b){'dfp-isb'===a&&b.setTargeting('Sidebar',['Inline']),'dfp-tsb'===a&&b.setTargeting('Sidebar',['Right']);var c=k(a),d=c.path,e=c.sizes,f=c.zone,g=googletag.defineSlot(d,e,a);n(f)&&g.setCollapseEmptyDiv(!0,!0),g.addService(b),!1}function p(b){return function(){l(),googletag.destroySlots();var c=googletag.pubads();c.enableSingleRequest(),a.sreEvent||(c.addEventListener('slotRenderEnded',m),a.sreEvent=!0),!dfp_targeting||Object.keys(dfp_targeting).forEach(function(a){c.setTargeting(a,dfp_targeting[a])}),b.forEach(function(a){return o(a,c)}),googletag.enableServices(),b.forEach(function(a){googletag.display(a)})}}var r=function(a){for(var b=[],c=1;c<arguments.length;c++)b[c-1]=arguments[c];for(var d,e=0,f=b;e<f.length;e++)for(var g in d=f[e],d)a[g]=d[g];return a}({"lib":"https://cdn.sstatic.net/clc/clc.min.js?v=8d2ce55e5023","style":"https://cdn.sstatic.net/clc/styles/clc.min.css?v=8a0a093a431f","u":"https://clc.stackoverflow.com/markup.js","wa":true,"kt":2000,"tto":true,"h":"clc.stackoverflow.com","allowed":"^(((talent\\.)?stackoverflow)|(blog\\.codinghorror)|(serverfault|askubuntu)|([^\\.]+\\.stackexchange))\\.com$","wv":true,"al":false,"dh":[4385506061,4386578282,4386579572]},a.options||{}),q=a.cmd||[],s='248424177',t=/^\/tags\//.test(location.pathname)||/^\/questions\/tagged\//.test(location.pathname)?'tag-pages':'question-pages',u=location.hostname;var v={slots:{lb:[[728,90]],mlb:[[728,90]],sb:function(a){return'dfp-tsb'===a?[[300,250],[300,600]]:[[300,250]]},"tag-sponsorship":[[730,135]],"mobile-below-question":[[320,50],[300,250]]},ids:{"dfp-tlb":'lb',"dfp-mlb":'mlb',"dfp-tsb":'sb',"dfp-isb":'sb',"dfp-tag":'tag-sponsorship',"dfp-m-aq":'mobile-below-question',"clc-tlb":'lb',"clc-mlb":'mlb',"clc-tsb":'sb'}},w=function(a){new Image().src='https://'+r.h+'/stalled.gif?'+a};i(),a.autoload=h,a.cmd=q,a.options=r,a.loadDisplayAds=function(a){a=a&&0<a.length?a:j();var g=a.map(b).filter(e).filter(function(a){return /^\s*$/.test(a.innerHTML)}).filter(d).map(function(a){return a.id});if(j().map(b).filter(e).filter(c).forEach(f),0!==g.length){var h='undefined'==typeof googletag;if(h){googletag={cmd:[]};var i=document.createElement('script');i.src='https://www.googletagservices.com/tag/js/gpt.js',document.body.appendChild(i)}googletag.cmd.push(p(g))}}})(this.clc=this.clc||{})}catch(a){window.console.error(a)}</script>            <script>
                var clc = clc || {};
                    
                    clc.cmd = clc.cmd || [];
                    clc.cmd.push(function () {
window.clc_request='AiuRKmHIuNUIAAAAAIOK5wICAAAAAgAAAAAKAAAAfGN8c3RyaW5nfACOKjz05gs8nd1F'; clc.load();                     });
                ...
                <div class="module sidebar-related">
                    ...
                    <div class="related js-gps-related-questions" data-tracker="rq=1">
                        <div class="spacer"><a href="/q/931092" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted extra-large">1029</div></a><a href="/questions/931092/reverse-a-string-in-python" class="question-hyperlink">Reverse a string in Python</a></div><div class="spacer"><a href="/q/1384073" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">0</div></a><a href="/questions/1384073/problem-with-flushing-input-stream-c" class="question-hyperlink">problem with flushing input stream C</a></div><div class="spacer"><a href="/q/4715807" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">1</div></a><a href="/questions/4715807/casting-chars-from-input-to-string" class="question-hyperlink">Casting chars from input to string</a></div><div class="spacer"><a href="/q/4911236" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">1</div></a><a href="/questions/4911236/reversing-a-string-of-integers-user-enters-c" class="question-hyperlink">reversing a string of integers user enters (C)</a></div><div class="spacer"><a href="/q/5977326" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">36</div></a><a href="/questions/5977326/call-printf-using-va-list" class="question-hyperlink">call printf using va_list</a></div><div class="spacer"><a href="/q/13339603" title="Vote score (upvotes - downvotes)"><div class="answer-votes default">0</div></a><a href="/questions/13339603/logic-error-in-string-reversal-c" class="question-hyperlink">logic error in string reversal C</a></div><div class="spacer"><a href="/q/22831789" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">0</div></a><a href="/questions/22831789/fgets-does-not-seem-to-be-invoked" class="question-hyperlink">Fgets does not seem to be invoked</a></div><div class="spacer"><a href="/q/40238465" title="Vote score (upvotes - downvotes)"><div class="answer-votes default">0</div></a><a href="/questions/40238465/strncpy-string-c-programming-doesnt-perform-well-the-second-time" class="question-hyperlink">Strncpy (String C programming) doesn&#39;t perform well the second time</a></div><div class="spacer"><a href="/q/40349768" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">1</div></a><a href="/questions/40349768/strcpychar-char-a-is-giving-incorrect-output-reversing-a-string-word-by-w" class="question-hyperlink">strcpy(char*,char a[]) is giving incorrect output. (Reversing a string word by word)</a></div><div class="spacer"><a href="/q/48282630" title="Vote score (upvotes - downvotes)"><div class="answer-votes answered-accepted default">1</div></a><a href="/questions/48282630/troubles-creating-a-get-string-function-in-c" class="question-hyperlink">Troubles creating a get string function in C</a></div>
                    </div>
                </div>
...
<div id="hot-network-questions" class="module tex2jax_ignore">
    ...
    <ul>
            <li >
                <div class="favicon favicon-unix" title="Unix &amp; Linux Stack Exchange"></div><a href="https://unix.stackexchange.com/questions/443146/what-is-the-purpose-of-in-the-command-sed-s-g" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:106 }); posts_hot_network.click({ item_type:2, location:11 })">
                    What is the purpose of &quot;~&quot; in the command &quot;sed &#39;s~ ~~g&#39;&quot;?
                </a>

            </li>
            <li >
                <div class="favicon favicon-worldbuilding" title="Worldbuilding Stack Exchange"></div><a href="https://worldbuilding.stackexchange.com/questions/111349/how-can-a-colony-of-teleporters-make-the-most-money-while-keeping-their-teleport" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:579 }); posts_hot_network.click({ item_type:2, location:11 })">
                    How can a colony of teleporters make the most money while keeping their teleportation a secret?
                </a>

            </li>
            <li >
                <div class="favicon favicon-worldbuilding" title="Worldbuilding Stack Exchange"></div><a href="https://worldbuilding.stackexchange.com/questions/111975/what-sort-of-rules-limitations-could-govern-and-affect-a-crystal-resource-that" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:579 }); posts_hot_network.click({ item_type:2, location:11 })">
                    What sort of rules / limitations could govern and affect a crystal resource that is both anti-gravity and energy-producing?
                </a>

            </li>
            <li >
                <div class="favicon favicon-interpersonal" title="Interpersonal Skills Stack Exchange"></div><a href="https://interpersonal.stackexchange.com/questions/14337/parents-less-than-desireable-response-to-my-good-news-how-to-let-them-know-i-d" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:680 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Parents&#39; less than desireable response to my good news, how to let them know I did not like that?
                </a>

            </li>
            <li >
                <div class="favicon favicon-security" title="Information Security Stack Exchange"></div><a href="https://security.stackexchange.com/questions/185435/how-can-i-protect-my-website-against-bitsquatting" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:162 }); posts_hot_network.click({ item_type:2, location:11 })">
                    How can I protect my website against bitsquatting?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-worldbuilding" title="Worldbuilding Stack Exchange"></div><a href="https://worldbuilding.stackexchange.com/questions/111977/how-could-an-animal-run-fast-using-blade-like-feet-that-sink-into-spongy-ground" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:579 }); posts_hot_network.click({ item_type:2, location:11 })">
                    How could an animal run fast using blade-like feet that sink into spongy ground?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-writing" title="Writing Stack Exchange"></div><a href="https://writing.stackexchange.com/questions/36064/would-it-confuse-my-readers-to-give-two-siblings-nicknames-that-can-be-abbreviat" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:166 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Would it confuse my readers to give two siblings nicknames that can be abbreviations of the same name?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-superuser" title="Super User"></div><a href="https://superuser.com/questions/1321840/is-this-definition-of-bios-incorrect" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:3 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Is this definition of BIOS incorrect?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-academia" title="Academia Stack Exchange"></div><a href="https://academia.stackexchange.com/questions/109343/slept-through-final-professor-is-giving-me-a-zero-and-failing-me-is-there-any" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:415 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Slept through final, professor is giving me a zero and failing me – is there anything I can do to change this?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-codegolf" title="Programming Puzzles &amp; Code Golf Stack Exchange"></div><a href="https://codegolf.stackexchange.com/questions/164629/split-and-capitalize" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:200 }); posts_hot_network.click({ item_type:2, location:11 })">
                    split and capitalize
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-music" title="Music: Practice &amp; Theory Stack Exchange"></div><a href="https://music.stackexchange.com/questions/70953/is-it-normal-that-my-bridge-is-this-low-the-sides" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:240 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Is it normal that my bridge is this low the sides?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-math" title="Mathematics Stack Exchange"></div><a href="https://math.stackexchange.com/questions/2778914/a-confusion-about-the-second-connection-axiom-of-euclidean-geometry" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:69 }); posts_hot_network.click({ item_type:2, location:11 })">
                    A confusion about the second connection axiom of Euclidean Geometry
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-travel" title="Travel Stack Exchange"></div><a href="https://travel.stackexchange.com/questions/114689/where-and-why-are-there-metric-road-signs-in-arizona" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:273 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Where and why are there metric road signs in Arizona?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-dba" title="Database Administrators Stack Exchange"></div><a href="https://dba.stackexchange.com/questions/206485/best-situation-to-use-read-uncommitted-isolation-level" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:182 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Best situation to use READ UNCOMMITTED isolation level
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-rpg" title="Role-playing Games Stack Exchange"></div><a href="https://rpg.stackexchange.com/questions/122438/can-mage-hand-extinguish-exposed-flame-light-sources" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:122 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Can Mage Hand extinguish exposed flame light sources?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-music" title="Music: Practice &amp; Theory Stack Exchange"></div><a href="https://music.stackexchange.com/questions/70933/what-are-some-of-the-tips-for-musicians-starting-out-as-teachers" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:240 }); posts_hot_network.click({ item_type:2, location:11 })">
                    What are some of the tips for musicians starting out as teachers?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-academia" title="Academia Stack Exchange"></div><a href="https://academia.stackexchange.com/questions/109670/clearinghouse-for-physics-postdoc-positions" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:415 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Clearinghouse for Physics Postdoc positions?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-interpersonal" title="Interpersonal Skills Stack Exchange"></div><a href="https://interpersonal.stackexchange.com/questions/14377/how-to-address-a-someone-who-is-constantly-offended-on-my-behalf" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:680 }); posts_hot_network.click({ item_type:2, location:11 })">
                    How to address a someone who is constantly offended on my behalf
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-academia" title="Academia Stack Exchange"></div><a href="https://academia.stackexchange.com/questions/109233/student-caught-cheating-when-leaving-class-after-handing-me-the-exam" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:415 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Student caught cheating when leaving class after handing me the exam
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-rpg" title="Role-playing Games Stack Exchange"></div><a href="https://rpg.stackexchange.com/questions/122434/can-i-command-both-ghouls-and-zombies-skeletons-with-one-bonus-action" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:122 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Can I command both Ghouls and Zombies/Skeletons with one bonus action?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-interpersonal" title="Interpersonal Skills Stack Exchange"></div><a href="https://interpersonal.stackexchange.com/questions/14339/how-to-politely-tell-my-professor-that-i-dont-understand-anything-of-her-class" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:680 }); posts_hot_network.click({ item_type:2, location:11 })">
                    How to politely tell my professor that I don&#39;t understand anything of her class and that I want a lot of office hours?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-aviation" title="Aviation Stack Exchange"></div><a href="https://aviation.stackexchange.com/questions/51430/why-arent-any-wingsuits-able-to-sustain-flight" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:528 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Why aren&#39;t any wingsuits able to sustain flight?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-math" title="Mathematics Stack Exchange"></div><a href="https://math.stackexchange.com/questions/2776158/is-the-blue-area-greater-than-the-red-area" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:69 }); posts_hot_network.click({ item_type:2, location:11 })">
                    Is the blue area greater than the red area?
                </a>

            </li>
            <li class="dno js-hidden">
                <div class="favicon favicon-movies" title="Movies &amp; TV Stack Exchange"></div><a href="https://movies.stackexchange.com/questions/88920/how-did-thor-get-into-wakanda" class="js-gps-track" data-gps-track="site.switch({ item_type:11, target_site:367 }); posts_hot_network.click({ item_type:2, location:11 })">
...
<div id="feed-link">
    <a href="/feeds/question/48728707" title="feed of this question and its answers">
...
<script>StackExchange.ready(function(){$.get('/posts/48728707/ivc/855f');});</script>
<noscript><div><img src="/posts/48728707/ivc/855f" class="dno" alt="" width="0" height="0"></div></noscript><div style="display:none" id="prettify-lang">lang-c</div></div>
        ...
        <div class="site-footer--container">
            ...
            <nav class="site-footer--nav">
                    ...
                    <div class="site-footer--col site-footer--col__visible js-footer-col" data-name="default">
                        ...
                        <ul class="-list">
                            <li class="-item"><a href="https://stackoverflow.com/teams" class="js-gps-track -link" data-gps-track="footer.click({ location: 2, link: 29 })">Teams</a></li>
...
site design / logo &#169; 2018 Stack Exchange Inc; user contributions licensed under <a href="https://creativecommons.org/licenses/by-sa/3.0/" rel="license">cc by-sa 3.0</a>
                    ...
                    <span id="svnrev">rev&nbsp;2018.5.11.30364</span>
                </p>
            </div>
        </div>
...
<script>
            ...
            StackExchange.ready(function () {
                ...
                StackExchange.ga.init({
                    ...
                    StackExchange.ga.setDimension('dimension2', '|c|string|');
